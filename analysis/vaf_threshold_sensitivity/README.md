...
NMF가 시도할 수 있는 최대 시너지 수(이 분석에서는 8개)를 모두 써도 VAF 기준을 달성하지 못하는 경우입니다. 기준값을 너무 높이면 ceiling-hit이 늘어나, 결과의 신뢰도가 떨어집니다. ceiling-hit rate가 0이라는 것은 "모든 시험이 8개 이내 시너지로 기준을 달성했다"는 뜻입니다.
