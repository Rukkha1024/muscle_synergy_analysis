...
- Add statistical analysis: `analysis/{YYMMDD}-{HHMM}-{subject}/` reading only `outputs/final.parquet`.
...
- For `analysis/` work: the analysis folder + `outputs/final.parquet` schema (do not include pipeline code).
