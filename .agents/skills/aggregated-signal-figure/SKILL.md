...
- After generating sample outputs, always copy only those sample artifacts into `output/figures/sample_<task_name>/`.
- Keep original outputs unchanged and report the collected sample file list from that folder.
